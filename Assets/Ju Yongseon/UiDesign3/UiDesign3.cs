...
public class UiDesign3 : MonoBehaviour
{
    ...
    void Update()
    {
        if (WButtom)
        {
            ...
            wSkill.text = "ÁýÁß°ø°Ý";
            aSkill.text = "¼Ò¿ëµ¹ÀÌ";
            sSkill.text = "°­È­¾à¹°";

            skill_1.sprite =
                Resources.Load("Skills/ÁýÁß°ø°Ý", typeof(Sprite)) as Sprite;

            skill_2.sprite =
                Resources.Load("Skills/¼Ò¿ëµ¹ÀÌ", typeof(Sprite)) as Sprite;

            skill_3.sprite =
                Resources.Load("Skills/°­È­¾à¹°", typeof(Sprite)) as Sprite;
        ...
        if (AButtom)
        {
            ...
            skill_1.sprite =
                 Resources.Load("Skills/È­¿°¹æ»ç", typeof(Sprite)) as Sprite;

            skill_2.sprite =
                Resources.Load("Skills/À¯Åº¹ß»ç", typeof(Sprite)) as Sprite;

            skill_3.sprite =
                Resources.Load("Skills/°øÁßÆø°Ý", typeof(Sprite)) as Sprite;
        ...
        if (SButtom)
        {
            ...
            wSkill.text = "µ¶ ±¸¸§";
            aSkill.text = "ÀÍ½ºÇÃ·ÎÀü";
            sSkill.text = "¹ø°³";

            skill_1.sprite =
                Resources.Load("Skills/µ¶±¸¸§", typeof(Sprite)) as Sprite;

            skill_2.sprite =
                Resources.Load("Skills/ÀÍ½ºÇÃ·ÎÀü", typeof(Sprite)) as Sprite;

            skill_3.sprite =
                Resources.Load("Skills/¹ø°³1", typeof(Sprite)) as Sprite;
